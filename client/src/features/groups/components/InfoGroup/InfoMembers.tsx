  ...
  return (
    <div className="flex flex-col gap-4">
        ...
        <div className="max-w-max flex flex-col gap-2">
          ...
          <input type="text" placeholder='Buscar miembro' className='border-1 rounded-lg  py-2 px-4 placeholder:text-xs text-xs bg-input' onChange={(e) => setFilter(e.target.value)} />
