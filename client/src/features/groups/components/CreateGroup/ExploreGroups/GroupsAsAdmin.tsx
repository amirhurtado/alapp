  ...
  return (
    <div className="flex flex-col gap-2">
        ...
        <div className='relative w-[16rem] '>
            <Search size={19} strokeWidth={1} className='absolute  top-1/2 -translate-y-1/2 left-2 ' />
        <input onChange={(e) => setFilter(e.target.value)} type="text" placeholder='Busca por nombre'  className='w-full outline-none border p-3 pl-10 bg-input rounded-lg placeholder:font-poppins placeholder:text-sm text-sm'/>
